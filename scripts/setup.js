...
const appName = figlet.textSync('CHAMELEON SETUP', {
  font: 'Standard',
...
// Welcome message
console.log(boxen(
  `${rainbowTitle}\n\n${chalk.bold('Welcome to the Chameleon Setup Wizard!')}\n
...
async function main() {
  ...
  if (fs.existsSync(envPath)) {
    ...
    fs.writeFileSync(envPath, '# Chameleon Environment Variables\n\n');
  }
  ...
  // Write to .env file
  const envContent = `# Chameleon Environment Variables
